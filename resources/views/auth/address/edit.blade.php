...
<div class="container">
    ...
    <form action="{{ route('address.update', $address->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="flat_no" name="flat_no" value="{{ $address->flat_no }}" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="town" name="town" value="{{ $address->town }}" required>
        </div>
        <div class="mb-3">
